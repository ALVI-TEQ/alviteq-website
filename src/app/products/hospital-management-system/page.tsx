...
export default function HmsPage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(productSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema) }} />
    ...
    <section className="section container"><div className="section-head"><p className="eyebrow">Become a design partner</p><h2>Help shape ALVITEQ HMS.</h2><p className="lead">Hospitals, healthcare professionals, and technology partners can request a briefing or discuss the design-partner programme.</p></div><ContactForm defaultTopic="hms" defaultProduct="alviteq-hms" /></section>
  </>;
}
