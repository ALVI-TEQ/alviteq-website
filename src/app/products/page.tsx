...
export default function ProductsPage() {
  return <><PageHero eyebrow="Products by ALVITEQ" title="Technology becomes meaningful when it solves something real." intro="We build focused digital products around clear everyday problems." action={{label:"Explore OwnKeep",href:"/products/ownkeep"}} />
    ...
    <section className="section tint"><div className="container"><div className="future-product"><p className="eyebrow">Portfolio direction</p><h2>One public product. A deliberate long-term direction.</h2><p className="lead">ALVITEQ explores real-world problems where thoughtful design, intelligent technology, and dependable engineering can create lasting value. New products will appear here only when their purpose and availability are ready to verify.</p></div></div></section>
