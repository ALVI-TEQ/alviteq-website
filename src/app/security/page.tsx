...
export default function SecurityPage() {
  return <>
    ...
    <section id="responsible-disclosure" className="section tint"><div className="container"><div className="section-head"><p className="eyebrow">Responsible reporting</p><h2>Found a potential security issue?</h2><p className="lead">Send a concise description, affected page or product, reproduction steps, and potential impact to <a className="inline-link" href="mailto:security@alviteq.com">security@alviteq.com</a>. Do not include passwords, recovery passphrases, identity documents, patient information, or private records.</p></div></div></section>
