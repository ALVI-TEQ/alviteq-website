...
export const metadata = pageMetadata({ title: "About ALVITEQ", description: "Meet ALVITEQ, an independent technology company building secure products for individuals, organisations, and healthcare teams.", path: "/about" });

export default function AboutPage() {
  return <><PageHero eyebrow="About ALVITEQ" title="Powerful technology without unnecessary complexity." intro="ALVITEQ is an independent technology company building secure digital products for individuals, organisations, and healthcare teams." />
    <section className="section container"><div className="split"><div><p className="eyebrow">Why ALVITEQ exists</p><h2>Make capable technology genuinely useful.</h2><p className="lead">Technology can solve meaningful problems, but capability is valuable only when people can understand and depend on it. We create products that turn strong engineering into focused, accessible experiences.</p><p>ALVITEQ is an early-stage independent company building deliberately across personal technology and healthcare operations: one real problem and one verified improvement at a time.</p></div><div className="quote-panel">“Technology should become more capable without becoming more complicated.”</div></div></section>
    <section className="section tint"><div className="container"><div className="section-head"><p className="eyebrow">What we build</p><h2>Two contexts united by trust.</h2><p className="lead">OwnKeep helps people control important personal information. ALVITEQ HMS is being developed to help hospital teams coordinate complex operations responsibly.</p></div></div></section>
