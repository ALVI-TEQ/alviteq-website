...
export default function Home() {
  return <>
    <section className="v2-hero"><div className="container v2-hero-inner">
      ...
      <Image className="v2-hero-mark" src="/brand/official/alviteq-icon-512.png" width={512} height={512} alt="" priority />
    </div></section>
    ...
    <section className="v2-final"><div className="container v2-final-inner"><Image src="/brand/official/alviteq-icon-white-512.png" width={512} height={512} alt="" /><div><p className="eyebrow">Technology people can trust</p><h2>Have a useful problem<br />worth solving?</h2><p className="final-copy">Talk with ALVITEQ about OwnKeep, ALVITEQ HMS, product partnerships, or future opportunities.</p><Link className="button light" href="/contact">Contact ALVITEQ</Link></div></div></section>
  </>;
}
